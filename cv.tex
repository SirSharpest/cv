...
\begin{longtable}{r|p{9cm}}
  ...
  &Doonan Lab - Bioinformatician \\\textsc{Sept 2017 - Current}
...
\begin{tabular}{rll}	
  ...
  \textsc{June} 2018  & \textbf{BSc Computer Science} & Predicted Grade: 1:1 \\
  ...
  \\
  \textsc{June} 2010& \textbf{GCSEs} & Final Grades: Pass
\end{tabular}
...
\begin{tabular}{p{7cm}|l}
  ...
  Non-destructive, high-content analysis of wheat grain traits using X-ray micro computed tomography & \href{https://doi.org/10.1186/s13007-017-0229-8}{https://doi.org/10.1186/s13007-017-0229-8}
